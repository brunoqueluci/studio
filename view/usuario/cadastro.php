    ...
    <form method="POST" action="\studio\controller\login.php">
        <div class="row">
                ...
                <div class="form-group">
                    <fieldset disabled>
                        <div class="form">
                            ...
                            <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Código">
                        </div>
                    </fieldset>
                </div>
            </div>
            <div class="col-2">
                <div class="form-inline">
                    <label class="sr-only" for="inlineFormInputName2">Código</label>
                    <input type="date" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Código">
                </div>
            </div>
            <div class="col-2">
                <div class="form-inline">
        ...
        <div class="row">
            <div class="col-6 my-1">
                <label class="sr-only py-1" for="inlineFormInputName2">Nome do produto</label>
        ...
        <div class="row">
            ...
            <div class="col-2 my-1 align-items-center">
                <a href="#">
