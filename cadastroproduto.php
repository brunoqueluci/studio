...
<head>
    ...
    <script src="C:/wamp64/www/studio/assets/js/jquery.js"></script>
...
<div class="container">
    <div class="col form-group">
        <form action="controller\produto\Cadastro.php" method="POST" id="cadastroproduto" >
            <div class="row">
...
<script src="C:/wamp64/www/studio/js/produto/cadastroProduto.js"></script>
</body>
</html>
